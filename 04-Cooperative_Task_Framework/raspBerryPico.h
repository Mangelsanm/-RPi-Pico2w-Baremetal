...
#define GPIO3_BASEADDR		(IOBANK0_BASEADDR + 0X0018)
#define GPIO4_BASEADDR		(IOBANK0_BASEADDR + 0X0020)
#define GPIO5_BASEADDR		(IOBANK0_BASEADDR + 0X0028)
#define GPIO6_BASEADDR		(IOBANK0_BASEADDR + 0X0030)
#define GPIO7_BASEADDR		(IOBANK0_BASEADDR + 0X0038)
#define GPIO15_BASEADDR		(IOBANK0_BASEADDR + 0X0078)
...
#define GPIO3   ((IOBANK0_RegDef_t *)GPIO3_BASEADDR)
#define GPIO4   ((IOBANK0_RegDef_t *)GPIO4_BASEADDR)
#define GPIO5   ((IOBANK0_RegDef_t *)GPIO5_BASEADDR)
#define GPIO6   ((IOBANK0_RegDef_t *)GPIO6_BASEADDR)
#define GPIO7   ((IOBANK0_RegDef_t *)GPIO7_BASEADDR)
#define GPIO15  ((IOBANK0_RegDef_t *)GPIO15_BASEADDR)
...
typedef struct
{
    ...
    volatile uint32_t RESERVED1[1]; // Padding for 0x01C
    volatile uint32_t ILPR;         // IrDA Low-Power Counter Register (0x020)
